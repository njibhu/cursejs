...
function leaveServer(groupID, token, callback){
    ...
    req.post(parameters, null, function(errors, answer){
        if(errors === null){
            ...
            winston.log('error', 'groups-v1.leaveServer', 'Cannot complete request');
            callback(errors, undefined);
        }
    })
}
...
function joinInvitation(inviteCode, token, callback){
    ...
    req.post(parameters, null, function(errors, answer){
        if(errors === null){
            ...
            winston.log('error', 'groups-v1.joinInvitation', 'Cannot complete request');
            callback(errors, undefined);
        }
    })
}
...
function getInvitationDetails(inviteCode, token, callback){
    ...
    req.get(parameters, function(errors, answer){
        if(errors === null){
            ...
            winston.log('error', 'groups-v1.getInvitationDetails', 'Cannot complete request');
            callback(errors, undefined);
        }
    });
}
...
function getGroupMemberInfo(memberID, serverID, token, callback){
    ...
    req.get(parameters, function(errors, answer){
        if(errors === null){
            ...
            winston.log('error', 'groups-v1.getGroupMemberInfo', 'Cannot complete request');
            callback(errors, undefined);
        }
    })
}
...
function getGroupMembers(serverID, actives, page, pageSize, token, callback){
    ...
    req.get(parameters, function(errors, answer){
        if(errors === null){
            ...
            winston.log('error', 'groups-v1.getGroupMembers', 'Cannot complete request');
            callback(errors, undefined);
        }
    })
}
