...
class Channel {
    constructor(channelContract, server, client){
        ...
        this.conversation = client.conversations.get(channelContract.GroupID);
        if(this.conversation === undefined){
            this.conversation = new conversationsModule.Conversation(
                channelContract.GroupID, conversationsEndpoint.ConversationType.Group, client);
        }
    }

    _update(callback){
        //TODO Create/or delete Channel._update function
    }
}
