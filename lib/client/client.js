...
class Client extends EventEmitter {
    ...
    /**
     * Join a server using a speicified invite code.
     * @param  {string}   inviteCode Invitation code
     * @param  {Function} callback   Function callback
     * TODO: Update servers and channels automatically
     */
    redeemInvitation(inviteCode, callback){
        ...
        groupsEndpoints.joinInvitation(inviteCode, this.token, function(errors, content){
            if(callback === null){
                callback();
            } else {
                callback(errors);
