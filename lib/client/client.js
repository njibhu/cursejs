...
class Client extends EventEmitter {
    ...
    _renewSession(){
        var self = this;
        var renewRequest = new loginEndpoint.RenewTokenResponseContract(this.token, this._tokenExpires, this._tokenRenewAfter);
        loginEndpoint.loginRenew(renewRequest, this.token, function(errors, answer){
            if(errors === null){
