    ...
    handleFrame(data, flags){
        if (!this._authenticated){
            ...
            if(answer.TypeID == ProtocolV1.TypeID.ConversationMessageNotification){
                ...
                if(this.client.conversationList[answer.Body.ConversationID] == undefined){
                    ...
                    this.client.conversationList[answer.Body.ConversationID] = new ConversationsModule.Conversation(
                ...
                this.client.conversationList[answer.Body.ConversationID]._receivedMessageNotification(answer.Body);
            }
        }
    }
