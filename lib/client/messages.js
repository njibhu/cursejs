...
class Message {
    constructor(conversationMessageNotification, conversation, client){
        ...
        assert(client.messagesCache.get(conversationMessageNotification.ServerID) === undefined);
        client.messagesCache.set(conversationMessageNotification.ServerID, this);
    ...
    /**
     * Update a message from notification websocket
     * @param  {object} conversationMessageNotification ConversationMessageNotification object
     */
    _update(conversationMessageNotification){
    ...
    _selfCleaner(){
        ...
        this.client.messagesCache.delete(this.ID);
    }
